...
graduation_cap_icon = kv.PC.LucideIcon(label="graduation-cap",
                        #size="20px",
                        width=6,
...
def info_cards():
    with MuCtx:
        with Div(key="techonology_solutions",
                 classes='flex items-start gap-4') as tech_solutions_box:
            with Span(classes="shrink-0 rounded-lg bg-gray-800 p-4"):
                with ChildComp(child = graduation_cap_icon):
                    pass
    ...
    with MuCtx:            
        with Div(key="financial_services", classes='flex items-start gap-4') as financial_services_box:
            with Span(classes='shrink-0 rounded-lg bg-gray-800 p-4'):
                ...
                with LucideIcon(label="graduation-cap",
                                width=6,
                                stroke_color=icon_color
                                 ):
                    pass

            with Div() as healthcare_innovations_box:
